// Phase 4 Test Tool
// Go-based tool to test intermediate layer models
package main
...
func main() {
	fmt.Println("=== Precision Railroading Phase 4: Intermediate Layer Tests ===")
	fmt.Println()
	...
	if _, err := os.Stat(dbPath); os.IsNotExist(err) {
		fmt.Println("❌ Database not found. Run build_phase4.ps1 first.")
		os.Exit(1)
	}
	...
	testFiles := []TestFile{
		{Name: "int_state_intervals", Path: "tests/intermediate/test_int_state_intervals.sql"},
		{Name: "int_trip_segments", Path: "tests/intermediate/test_int_trip_segments.sql"},
		{Name: "int_cycle_classification", Path: "tests/intermediate/test_int_cycle_classification.sql"},
	}
